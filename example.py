...
import os
import sys
from renogybt import InverterClient, RoverClient, RoverHistoryClient, BatteryClient, LycanClient, DataLogger, Utils
...
elif config['device']['type'] == 'RNG_LYCAN':
    LycanClient(config, on_data_received).connect()
